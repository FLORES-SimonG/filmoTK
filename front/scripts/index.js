const movieService = require("./conexionMovieService");
...
document.addEventListener("DOMContentLoaded", () => {
  movieService.filmsDisponibles(repositorio, URL);
...
function configurarEventListeners() {
  ...
  botonReset.addEventListener("click", () => formulario.reset());
}

async function manejarEnvioFormulario(e) {
  e.preventDefault();
  await movieService.crearPelicula(e.target, repositorio, URL);
...
//!----------------------------------------------APUNTES GENERALES. DEBO MODULARIZAR----------------------------------------------
...
//     mostrarCartas();
//   } catch (error) {
//     (error) => alert("Error actualizado: " + error.message);
//   }
// };
